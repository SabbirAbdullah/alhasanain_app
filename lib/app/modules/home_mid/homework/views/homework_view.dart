              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      title:  Text(homework.subject!,style: const TextStyle(fontWeight: FontWeight.w500,fontSize: 12),),
                      subtitle:Text(homework.title!,style: const TextStyle(fontWeight: FontWeight.w400,fontSize: 12),),
                      trailing: Text(homework.date!,style: const TextStyle(fontWeight: FontWeight.w500,fontSize: 10),),
                    ),
                  ),
                );
              },
