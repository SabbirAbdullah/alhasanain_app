...
final EDairyController controller = Get.put(EDairyController());
  @override
    ...
    return PagingView(
        child: Column(
          children: [
            ...
            //     BoxShadow(
            //         color: Colors.grey.shade100, spreadRadius: 2, blurRadius: 1)
            //   ]),
            //   child: Padding(
            ...
            Obx(() {
              if (controller.projectList.isEmpty) {
                return const Padding(
                  ...
                  child: Center(child: Text("No E-Dairy available.")),
                );
              }
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      title: Padding(
                                        padding: EdgeInsets.only(
                                            ...
                                            bottom: 4),
                                        child: Text(
                                          " ${controller.projectList[index].title}",
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 16),
                                        ),
                                          ...
                                          children: [
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 16.0),
                                              child: Text(
                                                "${controller.projectList[index].description}",
                                                style: TextStyle(
