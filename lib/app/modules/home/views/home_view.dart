                  ...
                  SectionHeader(
                      ...
                      onTap: () {
                        weeklyDatesController.fetchWeeklyDates(
                          homeController.term.value,
                          homeController.studentDataList[0].cId!,
                          homeController.studentDataList[0].secId!,
                          homeController.studentDataList[0].campus!,
                          homeController.studentDataList[0].session!,
                        );
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child:  const Padding(
                                                        padding:
                                                        EdgeInsets.only(right: 8, left: 8, bottom: 2),
                                                        child: Text(
                                                          "N/A",
                                                          style: TextStyle(
                                                              color: Colors.black87,
