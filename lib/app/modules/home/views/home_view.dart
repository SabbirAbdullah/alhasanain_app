...
class HomeView extends BaseView<HomeController> {
  HomeView() {
    ...
    controller.fetchSubjectsForToday();

    //controller.getEventNewsData();
  }
  ...
  final ExamScheduleController examScheduleController = Get.put(ExamScheduleController());
  @override
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Image.asset("assets/images/alhasanain-logo.png",
                              height: 100, width: Get.width * 0.5),
                        ),
                         const Spacer(flex: 2,)
                        // Padding(
                        //   padding: EdgeInsets.only(
                        //     right: AppValues.padding_6,
                        //   ),
                        //   child: InkWell(
                        //     onTap: () {
                        //       showToast('No notification at the moment!');
                        //     },
                        //     child: Image.asset(
                        //       "assets/images/notification-bell.png",
                        //       height: AppValues.iconSize_25,
                        //       width: AppValues.iconSize_25,
                        //     ),
                        //   ),
                        // ),
                      ],
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                                                ...
                                                child: Row(
                                                  children: [
                                                    Container(
                                                      ...
                                                      child:  Padding(
                                                        padding: const EdgeInsets.only(
                                                            top: 4.0, bottom: 4, right: 8, left: 4),
                                                        child: Text(
                                                          controller.todayDay,
                                                          style: const TextStyle(
                                                              color: Colors.black87,
                  ...
                  SectionHeader(title: "Event & News", onTap: navigateEventNews),
                        ...
                        children: [
                          ListTile(
                            title: Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container( padding: EdgeInsets.only(top: 4,bottom: 4,left: 8,right: 8),
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12),color: Colors.grey.shade200),
                                  child:
                                      item.term == "CT"
                                          ?Text("Class Test",style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500),)
                                  :Text("Class Test",style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500),)),
                                SizedBox(height: 4,),
                            ...
                            subtitle:
                                Text(" Published At ${item.date?.toLocal().toString().split(' ')[0] ?? 'N/A'}",style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400,color: Colors.grey),),
                          ),
                        ],
                      ),
                    );
