...
class StudentsLoginWidget{


  static Widget getTextFormField(String title,TextEditingController controller,bool _isObsecure){
    return Column(
    ...
    return Padding(
      ...
      child: Center(
        child: Row(
          ...
          children: [
            SvgPicture.asset(color: Colors.black,('assets/images/vector_student.svg'),),
